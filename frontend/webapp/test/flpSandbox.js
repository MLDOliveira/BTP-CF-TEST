		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Book List",
									"targetURL": "#cominetuminetumfront-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cominetuminetumfront-display": {
								"semanticObject": "cominetuminetumfront",
								"action": "display",
								"description": "Inetum Test Project",
								"title": "Book List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.inetum.inetumfront",
									"url": sap.ui.require.toUrl("com/inetum/inetumfront")
								}
							}
						}
					}
